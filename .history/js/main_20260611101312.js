document.addEventListener('DOMContentLoaded', () => {
  ...
  // Slider Data
  const slidesData = [
    { img: 'img/slider/slide1.jpg', title: "ASSASSIN'S CREED", rate: "RATE 65%" },
    { img: 'img/slider/slide2.jpg', title: "CYBERPUNK 2077", rate: "RATE 82%" },
    { img: 'img/slider/slide3.jpg', title: "ELDEN RING", rate: "RATE 95%" }
  ];
  ...
  slidesData.forEach((slide, index) => {
    ...
    slideDiv.innerHTML = `<img src="${slide.img}" alt="${slide.title}">`;
